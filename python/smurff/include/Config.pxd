...
cdef extern from "<SmurffCpp/Configs/Config.h>" namespace "smurff":
    ...
    const std::string SAVE_PREFIX_DEFAULT_VALUE "smurff::Config::SAVE_PREFIX_DEFAULT_VALUE"
    const std::string SAVE_EXTENSION_DEFAULT_VALUE "smurff::Config::SAVE_EXTENSION_DEFAULT_VALUE"
    ...
    const std::string STATUS_DEFAULT_VALUE "smurff::Config::STATUS_DEFAULT_VALUE"
    ...
    cdef cppclass Config:
        ...
        #-- aux data
        Config& addAuxData(shared_ptr[TensorConfig])
